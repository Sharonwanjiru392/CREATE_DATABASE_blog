<?php
session_start();
require 'db.php'; // Ensure you have a proper database connection in db.php

if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $title = $_POST['title'];  // Added title field
