...
<main class="form-signin w-100 m-auto">
  <form  method="POST" action="">
    <img class="mb-4 rounded-circle shadow" src="./uploads/a3.jpg" alt="" width="72" height="72">
    <h1 class="h3 mb-3 fw-normal">Please sign in</h1>

    <div class="form-floating">
      <input name="username" type="text" class="form-control mb-2" id="floatingInput" placeholder="Enter Your Username">
